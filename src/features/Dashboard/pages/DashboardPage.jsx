  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 px-6 py-16">
      <div className="max-w-6xl mx-auto text-center">
        ...
        {/* Time Chart */}
        <div className="bg-gray-900 border border-gray-800 rounded-2xl shadow-md p-6 mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {cards.map((card, i) => (
            ...
            >
              <Link
                to={card.link}
                className="group block bg-gray-900 border border-gray-800 rounded-2xl p-6 hover:shadow-blue-500/20 transition-all"
              >
                <FontAwesomeIcon
                  icon={card.icon}
