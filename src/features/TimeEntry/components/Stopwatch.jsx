...
export const Stopwatch = ({project, task}) => {
    ...
    <section>
      <div className="">
        <div className="flex mt-6 justify-evenly items-center gap-5 ">
          <div className="flex text-center tracking-tight font-light text-4xl size-45 justify-center items-center border-3 border-gray-500/50 rounded-full">
          ...
          <div className="flex">
            <button
              ...
              disabled={selectedProject !== undefined && task ? false : true}
            >
